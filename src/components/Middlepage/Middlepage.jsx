...
export default function Middlepage() {
  ...
  const filteredCars = carslist.filter(car =>
    (car.car + " " + car.car_model + " " + car.price)
      .toLowerCase()
      .includes(searchTerm.toLowerCase())
  );

 
  const firstFour = filteredCars.slice(0, 4);
      ...
      <div className="header">
        <div className={style.sec}>
          <div className={style.search}>
            ...
            <input type="search" placeholder="search for cars..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
